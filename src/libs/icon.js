export const icons = [
  ...
  },
  {
    ...
    tags: ['checkmark', 'success'],
  },
  {
    icons: ['ios-checkmark-circle', 'md-checkmark-circle'],
    tags: ['checkmark', 'circle', 'success'],
  },
  {
...
export const iconfont = [
  {
    icons: ['iconfont icon-github'],
    tags: ['github'],
  },
  {
    icons: ['iconfont icon-qq'],
    tags: ['qq'],
  },
  {
    icons: ['iconfont icon-weixin'],
    tags: ['weixin'],
  },
  {
    icons: ['iconfont icon-weibo'],
    tags: ['weibo'],
  },
  {
    icons: ['iconfont icon-dingding'],
    tags: ['dingding'],
  },
  {
    icons: ['iconfont icon-qiyeweixin'],
    tags: ['qiyeweixin'],
  },
  {
    icons: ['iconfont icon-menu-unfold'],
    tags: ['menu', 'unfold'],
  },
  {
    icons: ['iconfont icon-menu-fold'],
    tags: ['menu', 'fold'],
  },
]
