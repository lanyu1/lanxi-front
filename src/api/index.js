...
// 文件上传接口
export const uploadFile = "/lanxi/upload/file"
// 验证码渲染图片接口
export const drawCodeImage = "/lanxi/common/captcha/draw/"
// 获取菜单
export const getMenuList = "/lanxi/permission/getMenuList"
// 获取数据字典
export const getDictData = "/lanxi/dictData/getByType/"
